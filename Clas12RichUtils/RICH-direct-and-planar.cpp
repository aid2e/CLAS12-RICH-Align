...
#include "RICH-direct-and-planar.h"
#include "RICH-reflection-tools.h"

// For each aerogel tile and each hadron species
// want to determine mean of reco direct photon Cherenkov
// angle. Need a tree containing aerogel
// layer/tile #, SCALED traced cherenkov angle (\beta*cos(theta)).
// (or just \theta_cher and \beta/momentum)
