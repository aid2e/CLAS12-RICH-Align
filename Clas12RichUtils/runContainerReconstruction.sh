...
#TODO: Check if this path fix is not fully necessary with new container version
...
recon-util -y ${AIDE_HOME}/rich/yaml/rich.yaml -i ${AIDE_HOME}/skim_5232_ele_mergedLower_andMergedUpper.hipo -o ${OUTPUT_DIR}/rich/log/hipo_files/output_spherical_$1.hipo

${AIDE_HOME}/Clas12RichUtils/RICH-hipo-to-tree ${OUTPUT_DIR}/rich/log/root_files/output_spherical_$1.root ${OUTPUT_DIR}/rich/log/hipo_files/output_spherical_$1.hipo

EOF
python ${AIDE_HOME}/Clas12RichUtils/runObjectiveCalcEleMatching.py  $1
